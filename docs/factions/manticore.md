...
- It controls or operates a major share of Consortium interstellar-capable vessels.
- It protects and transports corporate interests between systems.
- Its dependence on megacorporate funding does not prevent it from becoming a political power in its own right.
- Each megacorporation also maintains smaller armed forces that are organizationally separate from MantiCORE.
